...
Go to `https://github.com/ait-testbed/attackmate.git <https://github.com/ait-testbed/attackmate.git>`_ and click on fork. Please note that you must login to GitHub first.
...
.. note::
  ...
  AttackMate uses `prek`_ to ensure code quality. Make sure to use it properly.
...
Please make sure that you updated your local development branch as described in section 8 above. Then push the changes to your GitHub repository to keep it up2date:
